...
public class NewsListAdapter1 extends RecyclerView.Adapter<NewsListAdapter1.BaseViewHolder>{
    ...
    public NewsListAdapter1(Context context, ArrayList<NewsListNormalBean> newsListNormalBeanList) {
        mContext = context;
    ...
    @Override
    public NewsListAdapter1.BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        if (viewType == BIG_IMG) {
    ...
    //
    @Override
    public void onBindViewHolder(final NewsListAdapter1.BaseViewHolder holder, int position) {
