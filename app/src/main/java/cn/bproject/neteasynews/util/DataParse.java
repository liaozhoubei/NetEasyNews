...
import cn.bproject.neteasynews.bean.*;
...
public class DataParse {
    ...
    // 新闻列表解析
    public static List<NewsListNormalBean> NewsList(String json, String id) {
        // Gson, JsonObject
        ...
        if (json != null) {
            ...
            try {
                ...
                e.printStackTrace();
                Log.e(TAG, "parseJson: 数据解析错误");
            }
        } else {
            Log.e(TAG, "parseData: 没有数据");
        }
        return null;
    }
     ...
     * @return
     */
    public static List<PicListBean> PicList(String result) {
        Log.e("图片返回的数据", "parseData: " + result);
     ...
     * @return
     */
    public static List<VideoBean> VideoList(String result) {
        if (result != null) {
            JSONObject jsonObject = null;
